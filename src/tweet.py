...
def set_credentials(secrets):
    ...
    return bearer_token, api_key, api_key_secret, access_token, \
        access_token_secret
...
def searchTwitter(client, start_time, end_time, max_results=10,
                  query="bolsonaro lang:pt"):

    tweets = client.search_recent_tweets(query=query, start_time=start_time,
                                         end_time=end_time,
